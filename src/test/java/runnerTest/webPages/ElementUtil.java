...
public class ElementUtil {
    ...
    public static WebElement webAction(final By locator){
        Wait<WebDriver> wait = new FluentWait<WebDriver>(BasePage.get())
                ...
                .withMessage(
                        "Webdriver waited for 15 seconds not still could not find the element therefore TimeOutException has been thrown "
                );
    ...
    /**
     * getScreenShot if your test is failed
     * @param name
     * @return
     */
    public String getScreenShot(String name){
        SimpleDateFormat df = new SimpleDateFormat("-yyyy-MM-dd-mm");
